								...
								{#each pubs.filter((pub) => pub.year === year) as pub}
									<div class="mt-4 flex gap-2">
										<span class="flex w-14 flex-none items-center justify-center">
											<span class="badge bg-primary-500 text-lg">
												<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="auto" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
